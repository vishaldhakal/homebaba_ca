...
export default function SidebarContact({ projectName, city, partnerdata }) {
  ...
  return (
    <div className="w-full">
      <div className="bg-white rounded-[20px] shadow-lg p-6 sm:p-8 w-full">
        <div className="flex items-start gap-3 sm:gap-4 mb-6 sm:mb-8">
          ...
          <div className="mt-2">
            <h2 className="text-[24px] sm:text-[28px] font-medium text-[#2C2C2C] leading-none mb-1">Receive a Call</h2>
            <p className="text-[13px] sm:text-[14px] text-[#2C2C2C] flex items-center">
              Homebaba Verified Partner
              <img src="/cc.png" alt="verified" className="w-3.5 h-3.5 sm:w-4 sm:h-4 ml-1" />
            </p>
          </div>
        </div>
        ...
        <form onSubmit={handleFormSubmit} className="space-y-4">
          <div className="grid grid-cols-2 gap-3 sm:gap-4">
            <input
              ...
              name="name"
              id="name"
              className="w-full px-3 sm:px-4 py-2.5 sm:py-3 border border-[#E5E7EB] rounded-lg text-[#2C2C2C] placeholder-[#6B7280] focus:outline-none focus:ring-1 focus:ring-[#2C2C2C] text-[14px] sm:text-base"
          ...
          <div className="relative">
            <select
              id="realtor"
              className="w-full px-3 sm:px-4 py-2.5 sm:py-3 border border-[#E5E7EB] rounded-lg text-[#2C2C2C] bg-white appearance-none focus:outline-none focus:ring-1 focus:ring-[#2C2C2C] text-[14px] sm:text-base"
            ...
            <div className="absolute top-0 left-4 -translate-y-2 px-1 bg-white">
              <span className="text-[11px] sm:text-xs text-[#6B7280]">Are you a realtor or working with a realtor?</span>
            </div>
            <div className="absolute inset-y-0 right-4 flex items-center pointer-events-none">
              <svg className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-[#6B7280]" viewBox="0 0 20 20" fill="currentColor">
          ...
          <textarea
            ...
            className="w-full px-3 sm:px-4 py-2.5 sm:py-3 border border-[#E5E7EB] rounded-lg text-[#2C2C2C] placeholder-[#6B7280] focus:outline-none focus:ring-1 focus:ring-[#2C2C2C] h-[100px] sm:h-[120px] resize-none text-[14px] sm:text-base"
          ...
          <button
            type="submit"
            className="w-full bg-black text-white py-3 sm:py-4 rounded-lg text-[15px] sm:text-[16px] font-medium hover:bg-gray-800 transition duration-200"
          >
            {submitbtn}
          </button>

          <p className="text-[10px] sm:text-[11px] text-[#6B7280] text-center leading-tight mt-4">
