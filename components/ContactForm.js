      ...
      <form onSubmit={handleFormSubmit} className="space-y-4">
        <div className="relative">
          <input
            ...
            id="name"
            name="name"
            className="w-full h-[70px] px-4 bg-[#F4F6F9] rounded-2xl border-0 focus:ring-0 text-gray-900 placeholder-gray-500"
        ...
        <div className="relative">
          <select
            id="realtor"
            name="realtor"
            className="w-full h-[70px] px-4 pt-6 pb-2 bg-[#F4F6F9] rounded-2xl border-0 focus:ring-0 text-gray-900 appearance-none peer"
        ...
        <div className="relative">
          <textarea
            ...
            name="message"
            rows={4}
            className="w-full px-4 py-6 bg-[#F4F6F9] rounded-2xl border-0 focus:ring-0 text-gray-900 resize-none placeholder-gray-500"
        ...
        <div className="flex justify-center mt-6">
          <button
            type="submit"
            className="w-full md:w-auto px-8 py-3 bg-black text-white rounded-2xl hover:bg-gray-800 transition-colors duration-200 text-center"
          >
            {submitbtn}
          </button>
        </div>
