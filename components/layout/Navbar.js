    ...
    <>
      <nav className="flex items-center justify-between px-4 py-3 bg-white sticky top-0 z-50 shadow-nav">
        ...
        <div className="hidden lg:flex items-center gap-3 xl:gap-6">
          ...
          >
            Most Anticipated
            <span className="bg-red-600 text-white text-[10px] px-1.5 py-0.5 rounded-sm font-medium">New</span>
          </button>
          <Link
            ...
            <SheetContent side="right" className="w-[300px] sm:w-[400px] p-0">
              <div className="flex flex-col h-full bg-white">
                <div className="flex flex-col py-4">
                  ...
                  >
                    Most Anticipated
                    <span className="bg-red-600 text-white text-[10px] px-1.5 py-0.5 rounded-sm font-medium ml-2">New</span>
                  </button>
                  <Link
                    href="/new-construction-homes"
                    onClick={() => setIsOpen(false)}
      ...
      <AnticipatedBottom isOpen={showAnticipated} onClose={() => setShowAnticipated(false)} />
    </>
  );
};
